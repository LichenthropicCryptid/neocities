...
<header>
    ...
    <div>
		<details class="draggable">
                    <summary>
                    <div>
                        <img id="access-fairy" src="https://lichenthropic.neocities.org/images/misc/tumblr_inline_o14jlnyNGa1tjuw11_500.gif" title="accessability fairy" alt="accessability menu" width="100px">
                    </div>
                    <br/>
                    </summary>
