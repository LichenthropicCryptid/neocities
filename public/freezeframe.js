document.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (freeze === "off") {
      ...
      e = new FreezeImages({ trigger: false, responsive: false });
  }
});
...
class FreezeImages {
  constructor(options = {}) {
    ...
    this.hover =
      options.hover === true || options.hover === "true" ? true : false;
    this.noCSS =
      options.no_css === true || options.hover === "true" ? true : false;
    this.smoothing = options.smoothing === true ? false : true;
